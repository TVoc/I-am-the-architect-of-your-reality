...
\begin{itemize}
	...
	\begin{itemize}
        ...
        \item \textit{Online Distribution Platform:} wants Recipients to use their services.
	\end{itemize}
...
\begin{itemize}
	...
	\begin{itemize}
		\item \textit{eDocs:} wishes to comply to the Recipient's preferences as to how he wants his documents to be delivered
		\item \textit{Recipient:} wants documents addressed to him to be delivered according to his wishes
        \item \texit{Online Distribution Platform:} wants to grasp the size of their userbase
	\end{itemize}
