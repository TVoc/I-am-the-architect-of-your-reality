...
Responsible for issuing notifications due to failure. The addressees can be both eDocs administrators (e.g. failure of hardware or software) and Customer Organization Administrators (e.g. document generation failure due to incorrect raw data).
