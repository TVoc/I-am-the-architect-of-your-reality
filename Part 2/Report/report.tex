...
This section gives an overview of the result of the three performed runs. This is not a complete ADD decomposition, thus there is still the notion of \texttt{OtherFunctionality} included. The structure is shown as a context diagram, and a set of component-connector diagrams.

\subsection{Context diagram}
Figure \ref{fig:cc_context} gives an overview of the external parties and their interaction with the system.

\begin{figure}[!htp]
    \centering
    \includegraphics[width=0.8\textwidth]{cont_diag_final.png}
    %\missingfigure[figwidth=0.8\textwidth]{Context diagram for component-and-connector view.}
    \caption{Context diagram for the component-and-connector view.
        }\label{fig:cc_context}
\end{figure}

\subsection{Component-and-connector view}
Figure \ref{fig:cc_main} shows a very high level overview of the resulting system after three decomposition runs. Figures \ref{fig:decomp_decomp1}, \ref{fig:decomp_decomp2} and \ref{fig:decomp_decomp3} give a more detailed structure of the actual decomposed subsystems, the actual results from our decomposition. A remark on figure \ref{fig:decomp_decomp3}: the \texttt{UserInformationMgmt} interface on the overview (figure \ref{fig:cc_main}) is embodied by the \texttt{RecipientInfoMgmt} and \texttt{CustomerOrganisationInformationManagement} interfaces.

\begin{figure}[!htp]
    \centering
    \includegraphics[width=0.8\textwidth]{comp_diag_final.png}
    %\missingfigure[figwidth=0.8\textwidth]{Component-and-connector diagram}
...
\begin{figure}[!htp]
    \centering
    \includegraphics[width=0.8\textwidth]{comp_diag_final1.png}
    %\missingfigure[figwidth=0.8\textwidth]{Key decomposition}
    \caption{Decomposition of the \texttt{GenerationSubsystem} component as mentioned in Figure~\ref{fig:cc_main}
        }\label{fig:decomp_decomp1}
\end{figure}

\begin{figure}[!htp]
    \centering
    \includegraphics[width=0.8\textwidth]{comp_diag_final2.png}
    %\missingfigure[figwidth=0.8\textwidth]{Key decomposition}
    \caption{Decomposition of the \texttt{StorageSubsystem} component as mentioned in Figure~\ref{fig:cc_main}
        }\label{fig:decomp_decomp2}
\end{figure}

\begin{figure}[!htp]
    \centering
    \includegraphics[width=0.8\textwidth]{comp_diag_final3.png}
    %\missingfigure[figwidth=0.8\textwidth]{Key decomposition}
    \caption{Decomposition of the \texttt{UserRegistrationSubsystem} component as mentioned in Figure~\ref{fig:cc_main}
        }\label{fig:decomp_decomp3}
\end{figure}
