...
When the \ttt{ErrorEmailDeliveryHandler} receives notice of an internal system error, it uses the throttling interface of the \ttt{NotificationEmailDeliveryHandler} as necessary. It then sends out an e-mail corresponding to the internal error. When the \ttt{ExternalNotificationAcceptor} receives confirmation of the delivery of this e-mail, the throttling is undone.
